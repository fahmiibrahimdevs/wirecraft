  ...
  return (
    <div className="w-80 bg-slate-50 dark:bg-slate-950/60 border-l border-slate-200 dark:border-slate-800 p-4 flex flex-col gap-4 overflow-y-auto">
      ...
      <div className="p-3 bg-white dark:bg-slate-900/60 rounded-xl border border-slate-200 dark:border-slate-800 flex flex-col gap-2.5 shadow-xs">
        ...
        <button
          onClick={onGeneratePinRow}
          className="w-full py-1.5 rounded-lg bg-sky-500/10 hover:bg-sky-500/20 dark:bg-sky-500/15 dark:hover:bg-sky-500/25 border border-sky-400/40 dark:border-sky-500/30 text-sky-700 dark:text-sky-300 text-xs font-medium flex items-center justify-center gap-1.5 transition-colors cursor-pointer"
        >
        ...
        <div className="p-3 bg-white dark:bg-slate-900 rounded-xl border border-sky-400/40 dark:border-sky-500/30 flex flex-col gap-3 shadow-md">
          <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-2">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <button
                ...
                className="p-1 rounded hover:bg-rose-500/10 dark:hover:bg-rose-500/20 text-slate-400 hover:text-rose-600 dark:hover:text-rose-400 transition-colors cursor-pointer"
                title="Hapus Pin"
              >
          ...
          <div>
            ...
            <select
              ...
              className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-700 rounded-lg px-2 py-1.5 text-xs text-slate-900 dark:text-slate-100 focus:border-sky-500 focus:outline-none cursor-pointer"
            >
              {PIN_TYPES.map((t) => (
          ...
          <div className="flex items-center justify-between bg-slate-50 dark:bg-slate-950 p-2 rounded-lg border border-slate-200 dark:border-slate-800">
            ...
            <div className="flex items-center gap-1">
              <button
                ...
                className="p-1 rounded bg-slate-200/80 hover:bg-slate-300 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 transition-colors cursor-pointer"
            ...
            return (
              <div
                ...
                className={`px-2.5 py-1.5 rounded-lg border text-xs flex items-center justify-between cursor-pointer transition-all ${
                  isSelected
                    ? 'bg-sky-50 dark:bg-sky-500/15 border-sky-300 dark:border-sky-500/50 text-sky-800 dark:text-sky-200 shadow-xs'
