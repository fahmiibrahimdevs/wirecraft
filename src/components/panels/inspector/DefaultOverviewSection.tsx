      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        ...
        <div className="bg-slate-50 dark:bg-slate-950/70 border border-slate-200 dark:border-slate-800 rounded-xl p-3.5 space-y-2">
          ...
          <ul className="text-[11px] text-slate-600 dark:text-slate-400 space-y-1.5 list-disc list-inside leading-relaxed">
            ...
            <li>
              <strong className="text-slate-700 dark:text-slate-300">Seleksi Banyak:</strong> Tahan{' '}
              <kbd className="bg-slate-200 dark:bg-slate-800 px-1 rounded text-[10px] text-slate-700 dark:text-slate-300 font-mono">
                Ctrl
              </kbd>{' '}
              /{' '}
              <kbd className="bg-slate-200 dark:bg-slate-800 px-1 rounded text-[10px] text-slate-700 dark:text-slate-300 font-mono">
            ...
            <li>
              <strong className="text-slate-700 dark:text-slate-300">Kabel:</strong> Klik pin awal &rarr; tarik &rarr; klik pin tujuan.
            </li>
            <li>
